  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1400px]">
        ...
        <h2 className="max-w-[20ch] font-display text-[length:var(--text-step-4)] font-extrabold uppercase leading-[0.9] tracking-[-0.01em] text-bone md:text-[length:var(--text-step-5)]">
        ...
        <dl className="mt-14 grid grid-cols-2 gap-x-8 gap-y-12 md:mt-20 md:grid-cols-4">
          {STATS.map((s) => (
            <div key={s.label} className="border-t border-bone/15 pt-6">
